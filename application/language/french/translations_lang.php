...
$lang['service_and_provider'] = 'Choisissez une consultation et un(e) soignant(e)';
$lang['select_service'] = 'Choisissez une consultation';
$lang['select_provider'] = 'Choisissez un(e) soignant(e)';
$lang['duration'] = 'Durée';
...
$lang['customer_details_title'] = 'Informations patient(e)';
$lang['service'] = 'Consultation';
$lang['provider'] = 'Soignant(e)';
$lang['customer'] = 'Patient(e)';
$lang['start'] = 'Début';
$lang['end'] = 'Fin';
$lang['name'] = 'Nom';
...
$lang['manage_appointment_record_hint'] = 'Gérer tous les enregistrements de rendez-vous des soignant(e)s et des consultations actives.';
$lang['select_filter_item_hint'] = 'Choisir un(e) soignant(e) ou une consultation et visualisez les rendez-vous sur l’agenda.';
$lang['enable_appointment_sync_hint'] = 'Activer la synchronisation des rendez-vous avec le calendrier Google du (de la) soignant(e).';
$lang['manage_customers_hint'] = 'Gérer les patient(e)s enregistrés et voir leur historique de rendez-vous.';
$lang['manage_services_hint'] = 'Gérer les consultations et les catégories actives du système.';
$lang['manage_users_hint'] = 'Gérer les utilisateurs du système (administrateurs, soignant(e)s, secrétaires).';
$lang['settings_hint'] = 'Régler les paramètres système et utilisateurs.';
$lang['log_out_hint'] = 'Déconnexion du système.';
$lang['unavailability_periods_hint'] = 'Durant les périodes d’indisponibilité l’soignant(e) n’acceptera pas de nouvelle consultation.';
...
$lang['select'] = 'Choisir';
$lang['hide'] = 'Cacher';
$lang['type_to_filter_customers'] = 'Filtrer les patient(e)s.';
$lang['clear_fields_add_existing_customer_hint'] = 'Effacer tous les champs et entrer un(e) nouveau(elle) patient(e).';
$lang['pick_existing_customer_hint'] = 'Rechercher un(e) patient(e) existant.';
...
$lang['provider_saved'] = 'Soignant(e) enregistré(e) avec succès.';
$lang['secretary_saved'] = 'Secrétaire enregistré·e avec succès.';
$lang['admin_deleted'] = 'Administrateur supprimé avec succès.';
$lang['provider_deleted'] = 'Soignant(e) supprimé(e) avec succès.';
$lang['secretary_deleted'] = 'Secrétaire supprimé·e avec succès.';
$lang['service_saved'] = 'Consultation enregistrée avec succès.';
$lang['service_category_saved'] = 'Catégorie de consultation enregistrée avec succès.';
$lang['service_deleted'] = 'Consultation supprimée avec succès.';
$lang['service_category_deleted'] = 'Catégorie de Consultation supprimée avec succès.';
$lang['customer_saved'] = 'Patient(e) enregistré(e) avec succès.';
$lang['customer_deleted'] = 'Patient(e) supprimé(e) avec succès.';
...
$lang['breaks'] = 'Pauses';
$lang['add_breaks_during_each_day'] = 'Ajoutez ici les périodes de pause pour chaque jour. Pendant ces pauses le(la) soignant(e) n’acceptera pas de rendez-vous...';
$lang['day'] = 'Jour';
$lang['days'] = 'Jours';
...
$lang['delete_customer'] = 'Supprimer le(a) patient(e)';
$lang['delete_service'] = 'Supprimer la consultation';
$lang['delete_service_category'] = 'Supprimer la catégorie de consultation';
$lang['delete_provider'] = 'Supprimer un(e) soignant(e)';
...
$lang['require_captcha_hint'] = 'Lorsque l’option est activée, les patient(e)s doivent taper un code de vérification CAPTCHA avant de pouvoir réserver ou mettre à jour un rendez-vous.';
...
$lang['customer_notifications'] = 'Notifications aux patient(e)s';
$lang['customer_notifications_hint'] = 'Définit si les patient(e)s reçoivent des notifications par email chaque fois qu’il y a un changement d’horaire de l’un de leurs rendez-vous.';
...
$lang['require_phone_number_hint'] = 'Lorsque activé, les patient(e)s et les utilisateurs devront entrer le numéro de téléphone du(de la) patient(e) lors de la prise de rendez-vous.';
...
$lang['display_any_provider_hint'] = 'La page de réservation obtiendra une option supplémentaire qui permet aux patient(e)s de réserver sans spécifier de fournisseur.';
...
$lang['disable_booking_hint'] = 'La page de réservation sera désactivée tant que ce paramètre sera actif et que les patient(e)s ne pourront pas enregistrer de nouveaux rendez-vous.';
...
$lang['theme'] = 'Thème';
$lang['limit_customer_access'] = 'Limiter l’accès des patient(e)s';
$lang['limit_customer_access_hint'] = 'S’ils sont activés, les fournisseurs et les secrétaires ne pourront accéder qu’à des patient(e)s avec lesquels ils ont rendez-vous.';
$lang['url'] = 'URL';
...
$lang['customer_save'] = 'Sauvegarde du (de la) patient(e)';
$lang['customer_delete'] = 'Supprimer le(la) patient(e)';
...
$lang['provider_save'] = 'Sauvegarde de le(la) soignant(e)';
$lang['provider_delete'] = 'Supprimer le(la) soignant(e)';
...
$lang['webhooks_info'] = 'les Webhooks vous permettent d’envoyer des notifications HTTP aux applications Web externes en réponse à divers événements d’application, tels que la création d’un rendez-vous ou la suppression d’un(e) patient(e).';
...
$lang['future_booking_limit_hint'] = 'Définissez la limite future en jours que les patient(e)s peuvent prendre rendez-vous via la page de réservation publique.';
...
$lang['year'] = 'Année';
$lang['make_non_working_day'] = 'Ce(tte) soignant(e) ne sera pas disponible pour travailler le jour sélectionné.';
...
$lang['customer_is_already_booked'] = 'Ce(tte) patient(e) a déjà un rendez-vous pendant la période de réservation demandée.';
$lang['fields'] = 'Champs';
