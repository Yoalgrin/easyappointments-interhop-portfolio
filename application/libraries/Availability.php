...
class Availability {
    ...
    protected function my_get_available_periods(String $date, Array $provider, Array $askedService = null, String $exclude_appointment_id = null) : Array
    {
        ...
        foreach ($appointments as $appointment)
        {
            ...
            //First filter in order to be able to block unavailabilities over multiple days (>2)
            if($appointment['is_unavailable'] == 1){
                $endDay = date_create_from_format('Y-m-d', substr($appointment['end_datetime'], 0, 10));
                //Getting the unavailable days in the interval...
                ...
                //... and only keeping those who are superiors to 2 days
                if(sizeof($arr) > 0){
                ...
                //Handling two days of unavailabilities in a row
                switch (true){
            ...
            }else{ //By default, the 'unavailable' appointments doesn't have a service and is ignored
